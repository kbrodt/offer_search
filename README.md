...
- [x] продолжить парсить сайты (Михаил и Артём)
...
- [ ] обернуть текущую реализацию слотфиллинга и запушить в общий пайплан
- [ ] добавить модуль постпроцессинга слотов в корректный вид для поисковика
